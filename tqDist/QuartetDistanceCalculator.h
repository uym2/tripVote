...
QuartetDistanceCalculator : private AbstractDistanceCalculator {
 public:
  ...
  std::vector<std::vector<double> > calculateAllPairsQuartetDistance(const char *filename, bool normalized=false);
  std::vector<std::vector<double> > calculateAllPairsQuartetDistance(std::vector<UnrootedTree *> trees, bool normalized=false);
