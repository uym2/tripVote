...
echo "Launching tripMVRoot. Using $clps_tree as reference"
tripMVRoot $clps_tree $g_trees $rg_trees 
echo "Finish tripMVRoot. Rooted trees were written to $rg_trees"
